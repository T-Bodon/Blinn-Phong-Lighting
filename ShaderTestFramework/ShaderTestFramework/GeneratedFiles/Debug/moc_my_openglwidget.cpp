...
QT_MOC_LITERAL(1, 16, 10), // "rotateDown"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 10) // "rotateLeft"

    },
    "My_OpenGLWidget\0rotateDown\0\0rotateLeft"
};
...
void My_OpenGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        My_OpenGLWidget *_t = static_cast<My_OpenGLWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->rotateDown(); break;
...
const QMetaObject My_OpenGLWidget::staticMetaObject = {
    { &QOpenGLWidget::staticMetaObject, qt_meta_stringdata_My_OpenGLWidget.data,
      qt_meta_data_My_OpenGLWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *My_OpenGLWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_My_OpenGLWidget.stringdata0))
        return static_cast<void*>(const_cast< My_OpenGLWidget*>(this));
    if (!strcmp(_clname, "QOpenGLFunctions"))
        return static_cast< QOpenGLFunctions*>(const_cast< My_OpenGLWidget*>(this));
